...
//          Serial.write(0x20);              //for terminal
           ...
           temp = i2s_slc_buf_pntr[rx_buf_idx][x];
           value =  *(int32_t*)&temp;  
           value = ((value>>13) - 120200)>>SIGNAL_GAIN;
           ...
           value =  *(int32_t*)&temp;  
           value = (value + 2300483647)<<(2 - SIGNAL_GAIN);  //2147483647 
           Serial.write((value>>8)&0xFF);        //for serial audio  16
           Serial.write((value>>16)&0xFF);     //for serial audio  16
           Serial.write((value>>24)&0xFF);    //for serial audio  16
#endif                     
...
//        Serial.printf("\n\r");
//       temp = temp>>16;
        temp = ((temp>>13) - 120200)>>SIGNAL_GAIN;                            //8192;//16384;//32768;//65536;  /SIGNAL_GAIN
